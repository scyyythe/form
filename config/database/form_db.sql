...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2025 at 03:20 AM
...
--
ALTER TABLE `birth_place`
  MODIFY `birth_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
...
--
ALTER TABLE `parents`
  MODIFY `parent_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
